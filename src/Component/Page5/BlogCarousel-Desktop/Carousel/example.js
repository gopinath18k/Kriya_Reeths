    ...
    content: (
      <div className="row all-blog-conatiner">
        <div className="all-blogs-heading">
          <h2 className="blogs-headings">Latest Articles</h2>
        </div>
        <div className="col-3 col-sm-3 col-md-3 col-lg-3  all-blog-content">
          <img src={EffectiveSocialMedia} alt="" className='blogs-images'/>
          <p className="blogs-small-head">Article </p>
          <Link className="head-sub-head" to='/blog/effective-social-media-marketing-services-in-coimbatore'><h3 className="blogs-head">Effective Social Media Marketing Services in Coimbatore: Boost Your Brand's Online Presence</h3></Link>
          ...
          <div className="blog-image-name">
            ...
            <p className="person-name">Kriya & Reeths <br></br><span className="person-discription">Coimbatore</span></p>
          </div>
        </div>
        <div className="col-3 col-sm-3 col-md-3 col-lg-3   all-blog-content">
        <img src={blog1} alt="" className='blogs-images'/>
          <p className="blogs-small-head">Article </p>
          <Link className="head-sub-head" to='/blog/significance-of-digital-marketing'><h3 className="blogs-head">What Is the Significance of Digital Marketing </h3></Link>
          <p className="blogs-paragraph">
        ...
        <img src={blog3} alt="" className='blogs-images'/>
          <p className="blogs-small-head">Article</p>
          <Link className="head-sub-head" to='/blog/why-professional-advertising-is-still-essential-for-business-growth-in-2026'><h3 className="blogs-head">Why Professional Advertising Is Still Essential for Business Growth in 2026</h3></Link>
          <p className="blogs-paragraph">
    ...
    content: (
      <div className="row all-blog-conatiner">
        ...
        <div className="col-3 col-sm-3 col-md-3 col-lg-3  all-blog-content">
          ...
          <p className="blogs-small-head">Article </p>
          <Link className="head-sub-head" to='/blog/digital-marketing-company-in-coimbatore'><h3 className="blogs-head">Digital Marketing Company in Coimbatore</h3></Link>
          <p className="blogs-paragraph">
        ...
        <img src={Best_Website_Development_Company} alt="" className='blogs-images'/>
          <p className="blogs-small-head">Article </p>
          <Link className="head-sub-head" to='/blog/best-website-development-company-in-coimbatore'><h3 className="blogs-head">Finding the Best Website Development Company in Coimbatore: Kriya Reeths</h3></Link>
          <p className="blogs-paragraph">
        ...
        <img src={Digital_Marketing_Company_in_GandhiPuram} alt="" className='blogs-images'/>
          <p className="blogs-small-head">Article</p>
          <Link className="head-sub-head" to='/blog/digital-marketing-company-in-gandhiPuram-coimbatore'><h3 className="blogs-head">Outline for Long-Form Article: "Digital Marketing Company in GandhiPuram, Coimbatore"</h3></Link>
          <p className="blogs-paragraph">
    ...
    content: (
      <div className="row all-blog-conatiner">
        ...
        <div className="col-3 col-sm-3 col-md-3 col-lg-3  all-blog-content">
          ...
          <p className="blogs-small-head">Article </p>
          <Link className="head-sub-head" to='/blog/digital-marketing-company-in-rs-puram-coimbatore'><h3 className="blogs-head">Digital Marketing Company in Rs Puram, Coimbatore</h3></Link>
          <p className="blogs-paragraph">
        ...
        <img src={Digital_Marketing_Company_in_Peelamedu} alt="" className='blogs-images'/>
          <p className="blogs-small-head">Article </p>
          <Link className="head-sub-head" to='/blog/digital-marketing-company-in-peelamedu-coimbatore'><h3 className="blogs-head">Digital Marketing Company in Peelamedu, Coimbatore: Boost Your Business with Kriya & Reeths </h3></Link>
          <p className="blogs-paragraph">
        ...
        <img src={Digital_Marketing_Agency_in_Coimbatore} alt="" className='blogs-images'/>
          <p className="blogs-small-head">Article</p>
          <Link className="head-sub-head" to='/blog/best-digital-marketing-agency-in-coimbatore'><h3 className="blogs-head">Best Digital Marketing Agency in Coimbatore</h3></Link>
          <p className="blogs-paragraph">
    ...
    content: (
      <div className="row all-blog-conatiner">
        ...
        <div className="col-3 col-sm-3 col-md-3 col-lg-3  all-blog-content">
          ...
          <p className="blogs-small-head">Article </p>
          <Link className="head-sub-head" to='/blog/digital-marketing-saravanampatti-in-coimbatore'><h3 className="blogs-head">Digital Marketing Company in Saravanampatti, Coimbatore</h3></Link>
          <p className="blogs-paragraph">
        ...
        <img src={Digital_Marketing_Company_in_Pollachi} alt="" className='blogs-images'/>
          <p className="blogs-small-head">Article </p>
          <Link className="head-sub-head" to='/blog/digital-marketing-pollachi-in-coimbatore'><h3 className="blogs-head">The Ultimate Guide to Choosing the Best Digital Marketing Company in Pollachi, Coimbatore</h3></Link>
          <p className="blogs-paragraph">
        ...
        <img src={Best_Branding_Company_in_Coimbatore} alt="" className='blogs-images'/>
          <p className="blogs-small-head">Article</p>
          <Link className="head-sub-head" to='/blog/best-branding-company-in-coimbatore'><h3 className="blogs-head">Best Branding Company in Coimbatore: Build a Powerful Brand with Kriya & Reeths</h3></Link>
          <p className="blogs-paragraph">
    ...
    content: (
      <div className="row all-blog-conatiner">
        ...
        <div className="col-3 col-sm-3 col-md-3 col-lg-3  all-blog-content">
          ...
          <p className="blogs-small-head">Article </p>
          <Link className="head-sub-head" to='/blog/best-seo-services-in-coimbatore'><h3 className="blogs-head">SEO Services in Coimbatore - Grow your Business with Kriya & Reeths</h3></Link>
          <p className="blogs-paragraph">
