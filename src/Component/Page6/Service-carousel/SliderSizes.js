...
const stages = [100, 66.66, 33.33, 0];
const labels = ["1", "2", "3", "4"];

const gradients = [
  'linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(232,232,232,1) 9%, rgba(46,45,45,1) 100%)', 
  'linear-gradient(180deg, rgba(43,43,43,1) 0%, rgba(255,255,255,1) 33.33%, rgba(43,43,43,1) 100%)', 
  'linear-gradient(180deg, rgba(43,43,43,1) 0%, rgba(255,255,255,1) 66.66%, rgba(43,43,43,1) 100%)',
