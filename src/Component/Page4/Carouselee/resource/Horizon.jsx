...
import horizonVideo from '../../../../vedios/Horizon.mp4';
import per1 from '../../../../images/Horizon.webp';
import perL1 from '../../../../images/Horizon Logo.webp';
import thumbnail from '../../../../images/HorizonThumb.webp'
      ...
      <div className="row pay-per-main pay-vid-pd pb-5">
        ...
        <div className="col-12 col-sm-6 pay-text-col">
          ...
          <p className="pay-per-para">
            Horizon Builders specializes in residential and commercial construction, delivering quality craftsmanship with modern design and reliable execution. Through our targeted Meta lead generation campaign, we connected with potential homebuyers and property owners actively looking for construction solutions, generating qualified inquiries while enhancing the brand's online visibility.
          </p>
          <div className="pay-sub">
            <div className="pay-sub-box">
              <h3 className="pay-sub-head">17,867+</h3>
              <h6 className="pay-sub-p">Reaches</h6>
            </div>
            <div className="pay-sub-box">
              <h3 className="pay-sub-head">₹217.70</h3>
              <h6 className="pay-sub-p"> Cost Per Result</h6>
            </div>
            <div className="pay-sub-box">
              <h3 className="pay-sub-head">55+</h3>
